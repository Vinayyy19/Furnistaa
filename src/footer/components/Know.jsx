  ...
  return (
    <div className="px-10 mt-5">
      ...
      <div className="flex mt-6 space-x-3 overflow-x-auto py-2">
        <img
          className="h-10 bg-white p-2 rounded object-contain"
        ...
        <img
          className="h-10 bg-white p-2 rounded object-contain hidden sm:block"
        ...
        <img
          className="h-10 bg-white p-2 rounded object-contain hidden md:block"
