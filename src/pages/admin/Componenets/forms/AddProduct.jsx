        ...
        >
          ...
          <div className="flex justify-end gap-4">
            <button
              ...
              disabled={loading}
              onClick={onClose}
              className="px-6 py-2 rounded-lg border border-neutral-600 text-neutral-300 hover:bg-neutral-800 disabled:opacity-50 cursor-pointer"
            >
              Cancel
            </button>
            <button
              type="submit"
              disabled={loading}
              className="px-6 py-2 rounded-lg bg-primary text-black font-semibold hover:opacity-90 disabled:opacity-50 cursor-pointer"
            >
